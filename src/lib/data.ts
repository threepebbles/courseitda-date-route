...
export const RECOMMENDED_PLACES: Place[] = [
  ...
  },
  {
    ...
    emoji: '🛍️',
    category: '거리',
    activityCategory: { main: ['walking', 'eating', 'viewing'] },
  },
  {
    id: 'rec-21',
    name: '경복궁',
  ...
  },
  {
    id: 'rec-24',
    name: '북촌 한옥마을',
    description: '전통 한옥이 보존된 아름다운 마을, 고즈넉한 분위기',
    lat: 37.5826,
    lng: 126.9830,
    emoji: '🏘️',
    category: '마을',
  ...
  },
  {
    ...
    description: '독특한 건축물과 다양한 전시, 행사 공간',
    lat: 37.5662,
    lng: 127.0094,
    emoji: '🏢',
    category: '문화시설',
    activityCategory: { main: ['viewing', 'walking', 'playing'] },
  },
  {
    id: 'rec-26',
    name: '광장시장',
    description: '다양한 먹거리와 구경거리가 가득한 전통 시장',
    lat: 37.5709,
    lng: 126.9961,
    emoji: '🍜',
    category: '시장',
  ...
  },
  {
    id: 'rec-27',
    name: '성수동 카페거리',
    description: '개성 있는 카페와 편집샵이 모여있는 트렌디한 거리',
    lat: 37.5447,
    lng: 127.0560,
    emoji: '☕',
    category: '거리',
  ...
  },
  {
    id: 'rec-28',
    name: '서울숲',
    description: '도심 속 대형 공원, 산책, 피크닉, 문화 행사',
    lat: 37.5441,
    lng: 127.0427,
    emoji: '🌳',
    category: '공원',
    activityCategory: { main: ['walking', 'viewing', 'playing'] },
  },
  {
    id: 'rec-29',
    name: '이태원 프리덤 거리',
    description: '다양한 문화와 이국적인 분위기를 느낄 수 있는 거리',
    lat: 37.5348,
    lng: 126.9944,
    emoji: '🌍',
    category: '거리',
    activityCategory: { main: ['eating', 'viewing', 'playing'] },
  },
  {
    id: 'rec-30',
    name: '용리단길',
    description: '이국적인 레스토랑과 카페가 많은 조용하고 분위기 있는 거리',
    lat: 37.5298,
    lng: 126.9691,
    emoji: '🍜',
    category: '거리',
